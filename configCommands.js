...
function mqttEnableHomeAssistantSaveCommand() {
  if (mqttEnableHomeAssistantCheckbox.checked()) {
    sendData("#mqhaen");
  } else {
    sendData("#mqhadi");
  }
...
function mqttHomeAssistantPrefixSaveCommand() {
  sanitizer = checkUserString(mqttHomeAssistantPrefixInput.value(), 50);
  if (sanitizer != null) {
